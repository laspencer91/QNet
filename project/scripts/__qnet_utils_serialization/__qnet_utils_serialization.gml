...
function QSerializer(_write_header_function, _read_header_function) constructor
{
	__WriteHeader = _write_header_function;
	__ReadHeader = _read_header_function;
	...
	{	
		...
		__WriteHeader(_buffer, _header_data);
	...
	function Deserialize(_buffer)
	{
		...
		var _header_data = __ReadHeader(_buffer);
		...
		{	
			...
			return { struct: __qnet_read_buffer_to_struct(_buffer, _struct_id), header_data: _header_data };
		}	
	}
